...
ODOO_APPS = [
    ...
    },
    {
        ...
        'desc': 'Multi-tier approval routing for purchase orders based on amount, department, or vendor.',
        'price': '$199',
        'icon': '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="40" height="40"><path d="M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z" fill="#4285F4"/></svg>',
    },
    {
        'name': 'Sales Commission Calculator',
        'desc': 'Compute rep commissions by tier, product category, or margin — synced to payroll.',
        'price': '$299',
        'icon': '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="40" height="40"><path d="M12 7.5c.97 0 1.75-.78 1.75-1.75S12.97 4 12 4s-1.75.78-1.75 1.75S11.03 7.5 12 7.5zM14 20h-4v-5H8l3.23-6.05c.34-.63 1.19-.63 1.53 0L16 15h-2v5zm6-9.99h-2V12h-2v-2h-2V8h2V6h2v2h2v2.01z" fill="#34A853"/></svg>',
    },
    {
